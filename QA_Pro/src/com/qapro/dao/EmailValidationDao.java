...
public class EmailValidationDao extends JavathlonJdbcTemplate<EmailValidation> {
	...
	public void insertValidation(EmailValidation emailValidation)
			throws Exception {
	...
	public EmailValidation getEmailValidationByEmail(String email) {
		...
		List<EmailValidation> allValidation = this.getList(sql,
				new SqlParameterValues().addValue("email", email),
				new EmailValidationRowMapper());
	...
	public void updateEmailValidationByEmail(EmailValidation emailValidation)
			throws Exception {
	...
	private class EmailValidationRowMapper implements
			SqlRowMapper<EmailValidation> {
