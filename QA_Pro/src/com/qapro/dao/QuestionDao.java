...
public class QuestionDao extends JavathlonJdbcTemplate<Question> {
	...
	public Question getQuestionById(Long id) {
		...
		List<Question> questionList = this.getList(sql,
				new SqlParameterValues().addValue("question_id", id),
	...
	public Question getQuestionByAskerId(Long id) {
		...
		List<Question> questionList = this.getList(sql,
				new SqlParameterValues().addValue("asker_id", id),
				new QuestionRowMapper());
	...
	public void voteQuestion(Long questionId, VotingEnum type) throws Exception {
		...
		if (VotingEnum.UP == type)
			this.update(upVoteSql, new SqlParameterValues().addValue(
					"question_id", questionId));
		else if (VotingEnum.DOWN == type)
			this.update(downVoteSql, new SqlParameterValues().addValue(
					"question_id", questionId));
